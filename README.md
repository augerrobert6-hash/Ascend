    ...
    <style>
        ...
        * {
        ...
        .btn {
            ...
            border-radius: 4px; /* Angles un peu carrés pour le côté "dur" */
        ...
        /* Placeholder pour ton Mockup 3D */
        .book-mockup {
            width: 350px;
            height: 500px;
            ...
            transform: rotateY(-10deg) rotateX(5deg); /* Petit effet 3D CSS */
        ...
        .price { font-size: 5rem; font-weight: 900; color: var(--text-main); }
        .price span { font-size: 1.5rem; color: var(--text-muted); }
        .price-list {
            list-style: none;
            text-align: left;
            margin: 30px 0;
        ...
        @media (max-width: 768px) {
            ...
            .book-mockup { margin: 0 auto; width: 280px; height: 400px; }
        }
    </style>
</head>
<body>
        ...
        <div class="container">
            ...
            <div class="grid-3">
                <div class="card hidden">
                    ...
                    <p style="color: #aaa; margin-top: 10px;">Un split précis jour par jour. Choix des exercices, tempos, temps de repos. Finies les approximations à la salle.</p>
                </div>
                <div class="card hidden">
                    <div class="card-icon">🍗</div>
                    <h3>La Nutrition</h3>
                    <p style="color: #aaa; margin-top: 10px;">Calculateur de macros inclus. Exemples de repas pour la prise de masse sèche ou le maintien. Gère ta diète sans te priver.</p>
                </div>
                <div class="card hidden">
                    <div class="card-icon">📈</div>
        ...
        <div class="container">
            <div class="price-box hidden">
                ...
                <ul class="price-list">
                    ...
                    <li>Guide des suppléments (ceux qui marchent)</li>
    ...
    <footer>
        <div class="container">
            <p>&copy; 2024 AlphaProtocol. Tous droits réservés. <br> <a href="#" style="color: #666;">Mentions Légales</a></p>
        </div>
    </footer>

    <script>
        // Petit script pour l'effet d'apparition au scroll (Style Framer)
